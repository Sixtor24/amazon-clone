    ...
    <div className="w-full bg-amazon_blue text-white sticky top-0 z-50">
      <div className="max-w-container mx-auto px-4 py-3 flex md:justify-between items-center gap-2 md:gap-4 lgl:gap-2 xl:gap-4">
        ...
        <div className="hidden mdl:inline-flex h-10 rounded-md flex-grow relative">
          <div className="w-14 h-full bg-gray-200 hover:bg-gray-300 border-2 cursor-pointer duration-300 text-sm text-amazon_blue font-titleFont flex items-center justify-center rounded-tl-md rounded-bl-md">
            All{" "}
            <span>
        ...
        {/* ============= SignIn Start here=========== */}
        {userInfo ? (
          <div onClick={() => signOut()} className="cursor-pointer flex gap-2 items-center headerHover">
            <Image
              width={500}
              height={500}
